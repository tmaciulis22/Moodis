...
namespace Moodis.Feature.Menu
{
    ...
    public class MenuActivity : AppCompatActivity
    {
        ...
        public MenuActivity(MenuViewModel viewModel, AppCompatActivity parent)
        {
        ...
        public async void UpdateLabels()
        {
            ...
            Bitmap bmImg = BitmapFactory.DecodeFile(menuViewModel.currentImage.ImagePath);
        ...
        {
            var bntToCalendar = FindViewById(Resource.Id.signInButton);
            var btnPlaySuggestedMusic = FindViewById(Resource.Id.signInFaceButton);
            var btnPlayMusic = FindViewById(Resource.Id.registerButton);
            var btnGroups = FindViewById(Resource.Id.registerButton);
            var btnTakePicture = FindViewById(Resource.Id.registerButton);
        }
    }
}